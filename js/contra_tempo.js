// Encapsula o módulo do cronômetro regressivo para evitar colisões globais
(function () {
    ...
    function atualizarRelogio() {
        ...
        // Atualizar no HTML — ALVO ESPECÍFICO: não tocar elementos com id duplicado
    ...
    // Expor API mínima no namespace para uso externo sem poluir globals
    window.CMContraTempo = {
        obterDadosPartida,
        obterTempoGasto,
        obterDataInicio,
        pararCronometro
